...
- **Log** – the last 200 state changes: shadows, screen on/off, wake-ups, camera checks,
  detection paused/resumed and failures. Only failures (and the boot receiver) are also
  written to Logcat under the tag `ProximityTurnOn`.
